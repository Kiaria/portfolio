      $.ajax({
        ...
        .done(function( msg ) {
           ...
           $(".thisulbox > ul > li > .wrap-star > b").eq(0).append("<span>"+msg.documents[0].price+"원</span>"+" "+msg.documents[0].sale_price+"원");
           ...
           $(".thisulbox > ul > li > .wrap-star > b").eq(1).append("<span>"+msg.documents[1].price+"원</span>"+" "+msg.documents[1].sale_price+"원");
           ...
           /// 3
            ...
            var str12=str11.substring(0,62);
           ...
           $(".thisulbox > ul > li > .wrap-star > b").eq(2).append("<span>"+msg.documents[2].price+"원</span>"+" "+msg.documents[2].sale_price+"원");
           ...
           $(".thisulbox > ul > li > .wrap-star > b").eq(3).append("<span>"+msg.documents[3].price+"원</span>"+" "+msg.documents[3].sale_price+"원");
           ...
           /// 5
            ...
            var str20=str19.substring(0,70);
           ...
           $(".thisulbox > ul > li > .wrap-star > b").eq(4).append("<span>"+msg.documents[4].price+"원</span>"+" "+msg.documents[4].sale_price+"원");
           ...
           /// 6
            ...
            var str24=str23.substring(0,80);
           ...
           $(".thisulbox > ul > li > .wrap-star > b").eq(5).append("<span>"+msg.documents[5].price+"원</span>"+" "+msg.documents[5].sale_price+"원");
           ...
           /// 7
            ...
            var str28=str27.substring(0,70);
           ...
           $(".thisulbox > ul > li > .wrap-star > b").eq(6).append("<span>"+msg.documents[6].price+"원</span>"+" "+msg.documents[6].sale_price+"원");
           ...
           /// 8
            ...
            var str32=str31.substring(0,80);
           ...
           $(".thisulbox > ul > li > .wrap-star > b").eq(7).append("<span>"+msg.documents[7].price+"원</span>"+" "+msg.documents[7].sale_price+"원");
